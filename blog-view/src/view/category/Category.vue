...
.category-page { max-width: 700px; margin: 0 auto; }
.category-page h1 { font-size: 1.5rem; font-weight: 700; margin-bottom: 4px; }
...
.category-blog-item { background: var(--surface); border: 1px solid var(--border-light); border-radius: var(--radius-lg); padding: var(--space-md); transition: all var(--duration-fast) ease; }
.category-blog-item:hover { border-color: var(--primary); }
