...
/**
 * Two-level cache (L1 Caffeine → L2 Redis) với per-key striped mutex + double-check stampede protection.
 * <p>
 * Null caching: khi loader trả null và policy.cacheNull=true, lưu sentinel marker
 * (Object placeholder trong L1, empty string trong L2) với TTL 30s để chống cache penetration.
 * <p>
 * Striped lock: mảng 512 ReentrantLock, key → hashCode % 512, không leak lock object.
 */
@Service
