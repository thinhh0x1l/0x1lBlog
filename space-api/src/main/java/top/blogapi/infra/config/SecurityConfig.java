...
import top.blogapi.infra.security.jwt.JwtAuthenticationFilter;
import top.blogapi.infra.security.MyAuthenticationEntryPoint;
import top.blogapi.infra.security.MyAccessDeniedHandler;
import top.blogapi.infra.security.oauth2.OAuth2LoginSuccessHandler;
import top.blogapi.infra.security.oauth2.CustomOAuth2UserService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/admin/**").hasAnyRole("ADMIN", "VISITOR")
