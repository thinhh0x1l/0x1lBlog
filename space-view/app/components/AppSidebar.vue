    ...
    <div class="sidebar-card">
      ...
      <div class="card-body">
        <div class="category-list">
          <NuxtLink v-for="cat in categories" :key="cat.id" :to="`/category/${cat.slug}`" class="category-item">
    ...
    <div class="sidebar-card">
      ...
      <div class="card-body">
        <div class="trending-list">
          <NuxtLink v-for="(post, idx) in trending" :key="post.id" :to="`/blog/${post.id}`" class="trending-item">
...
import { categories as mockCategories, hashtags, blogs as mockBlogs, badges as mockBadges } from '~/utils/dummy'

const authStore = useAuthStore()
const isLoggedIn = computed(() => authStore.isLoggedIn)
const user = computed(() => authStore.user)

const categories = ref<any[]>(mockCategories.slice(0, 8))
const tags = ref<any[]>(hashtags.slice(0, 10))
const trending = ref<any[]>(mockBlogs.filter(b => b.status === 'PUBLISHED').sort((a, b) => b.views - a.views).slice(0, 5))
const userBadges = ref<any[]>(mockBadges.slice(0, 5))
